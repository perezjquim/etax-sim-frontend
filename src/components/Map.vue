...
import LoadScript from 'vue-plugin-load-script';
  ...
  // As a global method
  Vue.loadScript("https://www.amcharts.com/lib/4/core.js");
  Vue.loadScript("https://www.amcharts.com/lib/4/maps.js");
  Vue.loadScript("https://www.amcharts.com/lib/4/geodata/worldLow.js");
  Vue.loadScript("https://www.amcharts.com/lib/4/geodata/continentsLow.js");
  Vue.loadScript("https://www.amcharts.com/lib/4/themes/animated.js");
...
(function()
{
        const map = {
                ...
                prepareCountriesData: function(chart, countries, continents)
                {
                        const data = [];
                ...
                prepareSeries: function(chart, countries, continents)
                {
                       ...
                       this.countrySeries.hide();
                        this.countrySeries.geodataSource.events.on("done", function(ev)
                        {
                        ...
                        worldPolygon.events.on("hit", function(ev)
                        {
                                ...
                                if (map)
                                {
                                        ...
                                        this.countrySeries.geodataSource.url = "https://www.amcharts.com/lib/4/geodata/json/" + map + ".json";
                        ...
                        var data = this.prepareCountriesData(chart, countries, continents);
                ...
                prepare: function()
                {
                        ...
                        this.prepareSeries(chart, countries, continents);
                        this.prepareZoom(chart);
                }
        };
