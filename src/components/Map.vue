...
<script>
    ...
    const map = {
        ...
        _getContinents: function () {
            return { "AF": 0, "AN": 1, "AS": 2, "EU": 3, "NA": 4, "OC": 5, "SA": 6 };
        },
        ...
        _prepareCountriesData: function () {
            ...
            for (var id in this.countries) {
                ...
                if (country.maps.length > 0) {
                    data.push({
                        id: id,
                        color: this.chart.colors.getIndex(this.continents[country.continent_code]),
                        map: country.maps[0]
                    });
                }
            }
        ...
        _prepareWorldSeries: function()
        {
            ...
            var worldPolygon = this.worldSeries.mapPolygons.template;
            worldPolygon.tooltipText = "{name}";
            worldPolygon.nonScalingStroke = true;
            worldPolygon.strokeOpacity = 0.5;
            worldPolygon.fill = am4core.color("#eee");
            worldPolygon.propertyFields.fill = "color";
            var world_hs = worldPolygon.states.create("hover");
            world_hs.properties.fill = this.chart.colors.getIndex(9);
        ...
        _prepareCountrySeries: function()
        {
            ...
            this.countrySeries.geodataSource.events.on("done", function () {
            ...
            var country_hs = countryPolygon.states.create("hover");
            country_hs.properties.fill = this.chart.colors.getIndex(9);
        ...
        onInit: async function () {
            ...
            if(!this.continents) this.continents = this._getContinents();
        ...
        onCountrySelected: function (ev) {
            ...
            const isConfigured = this.configured_countries.includes(country_id);
            if (isConfigured) {
                ev.target.series.chart.zoomToMapObject(ev.target);
                var map = ev.target.dataItem.dataContext.map;
                if (map) {
                    ev.target.isHover = false;
                    this.countrySeries.geodataSource.url = `${BASE_URL}/${map}.json`;
